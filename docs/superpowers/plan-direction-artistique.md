...
| 24 | ~~Mention conformité RGPD / hébergement santé~~ | **FAIT** (commit e1fd315) : aucune certification affirmée (aucune n'existe) — uniquement des pratiques réellement implémentées (accès par rôle, pas d'inscription publique, QR unique, tentatives de connexion limitées), avec une ligne de disclosure explicite et visible indiquant qu'une certification formelle n'est pas encore en place. | Faible (texte) | 0,5 j | landing.html |
