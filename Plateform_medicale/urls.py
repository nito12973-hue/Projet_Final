...
urlpatterns = [
    ...
    path('assure/prestataires/<int:pk>/', views.fiche_prestataire_assure, name='fiche_prestataire_assure'),
    path('assure/medecins/<int:pk>/', views.fiche_medecin_assure, name='fiche_medecin_assure'),
