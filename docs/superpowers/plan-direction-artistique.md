...
| 38 | ~~Écran "Ma carte" dédié, imprimable/exportable~~ | **FAIT** (commit b1ab86d) : export = Imprimer -> Enregistrer en PDF du navigateur, pas de pipeline reportlab dedie. | Moyenne | 2 j | nouveau template + views.py |
